...
// hand-resolved overrides for major music-touring markets where the city
// name exists in multiple states but ONE dominates by population + tour
// relevance. Lowercased city name → 2-letter state code.
